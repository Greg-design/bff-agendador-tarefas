...
public class CronService {
    ...
    public void buscaTarefasProximaHora(){
        ...
        LocalDateTime horaFuturaMais5Min = LocalDateTime.now().plusHours(1).plusMinutes(5);
        List<TarefasDTOResponse> listaTarefas = tarefasService.buscaTarefasAgendadasPorPeriodo(horaFutura, horaFuturaMais5Min, token);
