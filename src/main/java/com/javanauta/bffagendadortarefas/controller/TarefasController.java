...
@Tag(name = "Tarefas", description = "Cadastro tarefas de usuários") // Aqui no controller documentamos a api com o swagger.
...
public class TarefasController {
    ...
    @GetMapping
    @Operation(summary = "Busca lista tarefas por email de usuário", description = "Busca tarefas por email de usuário")
    @ApiResponse(responseCode = "200", description = "Tarefas encontradas")
    @ApiResponse(responseCode = "500", description = "Erro de Servidor")
